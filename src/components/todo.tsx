...
function Todo({
  ...
  return (
    <div className="w-11/12 mdw-3/5 h-80 md:h-fit mx-auto max-h-72 min-w-fit  ">
      <BoardContainer>
        <div
          onClick={(e) => {
            setOpenPrevTodos();
          ...
          className="absolute top-4 left-2 w-fit h-6 p-1 flex justify-between cursor-pointer text-sm"
        >
